...
public class ExemploSelectEnderecoPorEstado {
	...
	public static void main(String[] args) {
		...
		Long californiaID = StateProvinceDao.buscarIdPorCodigoDoEstado("CA"); // -> ERRO
		...
		EnderecosNaCalifornia.forEach(
				endereco -> System.out.println(endereco.getAddressLine1()+", "+endereco.getCity()+", ID_estado:"+endereco.getStateProvinceID())
		);
